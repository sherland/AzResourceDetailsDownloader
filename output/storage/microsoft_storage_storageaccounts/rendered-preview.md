...
| Property | Value |
|---|---|
| **Resource group** | rg-ardl-652dbcc623f75a16 |
...
| **Replication** | <!-- TODO (Unresolved): composite/derived — no single backing property (see NonTraceableLabels comments) --> Locally redundant storage (LRS) |
| **Account kind** | <!-- TODO (Unresolved): composite/derived — no single backing property (see NonTraceableLabels comments) --> StorageV2 (general purpose v2) |
| **Provisioning state** | Succeeded <sub>(as of last sync)</sub> |
| **Created** | August 14, 2026 at 10:28:04 UTC |
