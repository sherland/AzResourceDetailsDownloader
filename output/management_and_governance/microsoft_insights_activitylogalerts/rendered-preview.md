...
| **Severity** | <!-- TODO (Unresolved): composite/derived — no single backing property (see NonTraceableLabels comments) Captured example: "4 - Verbose" --> *Not available from captured ARM metadata.* |
