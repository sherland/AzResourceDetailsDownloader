...
public static class ScribanModelBuilder
{
    ...
    public static ScriptObject BuildModel(JsonElement root, string armType)
    {
        ...
        var m = new ScriptObject
        {
            ...
            ["storage_performance_label"] = PortalFriendlyLabels.StoragePerformanceLabel(root),
            ...
            ["appconfig_pricing_tier_label"] = PortalFriendlyLabels.AppConfigPricingTierLabel(root),
